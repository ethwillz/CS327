...
void saveload(Dungeon *dungeon, int *numRooms, char *arg1, char *arg2){
  ...
  //Is user adds both save and load switches
    ...
    readDungeonInfo(dungeonInfo, dungeon, numRooms);
...
void readDungeonInfo(FILE *dungeonInfo, Dungeon *dungeon, int *numRooms){
  ...
  //numRooms = malloc(sizeof((bytes-16820)/4));
  *numRooms = (bytes-16820)/4;
